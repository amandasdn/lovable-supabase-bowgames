...
const ReviewsModal = ({ game, onClose }: ReviewsModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div
        className="relative bg-card border border-primary/30 rounded-2xl max-w-4xl w-full max-h-[85vh] overflow-hidden shadow-card animate-in fade-in zoom-in-95 duration-200 flex flex-col ring-1 ring-primary/20"
      ...
      >
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          {/* Left: Reviews list */}
          <div className="flex-1 flex flex-col min-h-0 md:border-r md:border-primary/10">
            <div className="px-6 pt-4 pb-2">
              <h3 className="text-lg font-bold">User Reviews</h3>
            </div>
            <div ref={reviewListRef} className="flex-1 overflow-y-auto px-6 pb-4 reviews-scrollbar" style={{ maxHeight: "400px" }}>
              {allReviews.length === 0 ? (
          ...
          {/* Right: Submit form */}
          <div className="md:w-[340px] shrink-0 p-6 border-t border-border md:border-t-0">
